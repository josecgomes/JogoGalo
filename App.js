  ...
  return (
    ...
    <View style={styles.mainContainer}>
      ...
      <Pressable style={styles.cell_top_left}>
        <Image source={require('./assets/img/cross.png')} style={styles.icon}/>
      </Pressable>
      ...
      <Pressable style={styles.cell_mid_left}>
        <Image source={require('./assets/img/circle.png')} style={styles.icon}/>
      </Pressable>
    ...
    <Pressable style={styles.cancleBTN}>
      <Image source={require('./assets/img/replay.png')} style={styles.cancleIcon}/>
    </Pressable>
    </SafeAreaView>
  )
}
